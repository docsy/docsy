...
[0.7.0](https://github.com/docsy/docsy/releases/tag/v0.7.0). This major upgrade
was the result of
[six months of meticulous work (#470)](https://github.com/docsy/docsy/issues/470)
...
[PR #1566](https://github.com/docsy/docsy/pull/1566). If your project customizes
blog layouts, then you'll want to walk through the updates carefully. Otherwise,
your project will get these updates automatically, without any further required
changes.
...
[issue #470 · Upgrade to Bootstrap 5.2](https://github.com/docsy/docsy/issues/470)
...
- Default and accepted values of the `blocks/section`'s `type` argument have
  changed ([#1472](https://github.com/docsy/docsy/issues/1472))
...
The [docsy-example](https://github.com/docsy/docsy-example) repository is a
...
changes ([PR #221](https://github.com/docsy/docsy-example/pull/221)) were mainly
confined to the landing page of each natural language:

- Utility-class renames, such as `.ml-*` and `.mr-*` to `.ms-*` and `.me-*`
- [blocks/section](/docs/content/shortcodes/#blocks-section) changes
  ([PR #1472](https://github.com/docsy/docsy/pull/1472)):
  ...
  - Switched to `type="row"` for `blocks/section` elements that are rows (also
    from [PR #220](https://github.com/docsy/docsy-example/pull/220))
...
[discussion of 0.7.0](https://github.com/docsy/docsy/discussions/1555) or any
[later 0.7.x release](https://github.com/docsy/docsy/discussions/categories/announcement?discussions_q%3Dis%253Aopen%2Bcategory%253AAnnouncement).
