...
the old URLs, so clones, submodules, and `npm install google/docsy` keep working
-- but the **Hugo module path** changed with the move, and module paths don't
follow redirects: 0.18.0 and later are published only as
