...
- **If you produce MarkMap markup other than through a `markmap` fence on the
  ...
  partial; for the affected authoring paths and the one-line partial, see
  [MarkMap on other pages][markmap-other-pages].
...
[markmap-other-pages]:
  /docs/content/diagrams-and-formulae/#markmap-on-other-pages
