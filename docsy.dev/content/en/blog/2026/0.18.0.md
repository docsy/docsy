...
- **If you import Docsy as a Hugo module**, migrate as part of this upgrade (a
  `hugo mod get -u` under the old path never sees 0.18.0):
  1. In your site config, change the `module.imports` path from
     `github.com/google/docsy/theme` to `github.com/docsy/docsy/theme`.
...
- **If you install Docsy from GitHub through npm, a git submodule, or a clone**,
  re-point the reference to `docsy/docsy`; for a clone or submodule:
