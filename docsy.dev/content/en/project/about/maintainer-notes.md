...
is enough; the [script-version-pins test](#test-suites) guards the shape.
Renovate proposes routine bumps (see [Dependency updates](#dependency-updates)),
subject to a minimum release age. For each bump:
