...
from a shortcode. For MarkMap's authoring paths and how to widen its gate, see
...
[MarkMap on other pages]: /docs/content/diagrams-and-formulae/#markmap-on-other-pages
